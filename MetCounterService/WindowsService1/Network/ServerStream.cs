...
namespace WindowsMetService.Network
{
    class ServerStream
    {
        ...
        //static private readonly System.Net.IPAddress serverip = new IPAddress(new byte[] { 192, 168, 1, 6 });//***REMOVED***
        static private readonly System.Net.IPAddress serverip = new IPAddress(new byte[] { ***REMOVED*** });//***REMOVED***
